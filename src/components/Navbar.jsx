  ...
  return (
    <header>
      <nav
        ...
        className={`fixed top-6 left-1/2 -translate-x-1/2 z-50 transition-all duration-500 flex items-center justify-between px-6 py-3 w-[90%] max-w-4xl border border-transparent ${
          scrolled
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8 font-data text-sm">
          <a
            href="#profile"
            className="hover:-translate-y-px transition-transform cursor-pointer"
          >
            Profile
          </a>
          <a
        ...
        <a
          ...
          className={`group relative overflow-hidden px-5 py-2 font-sans font-bold text-sm flex items-center gap-2 transition-all duration-500 hover:scale-[1.03] active:scale-95 ${
            scrolled
        ...
        >
          ...
          <div
            className={`absolute inset-0 w-full h-full -translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-out z-0 ${
              scrolled ? "bg-dark" : "bg-primary/40"
            }`}
          ></div>
        </a>
      </nav>
