...
const ProjectShowcase = () => {
  const projects = [
    { name: "ccoco", tag: "Go / CLI", desc: "Change configurations on checkout.", url: "https://github.com/xarunoba/ccoco", img: "https://opengraph.githubassets.com/1/xarunoba/ccoco" },
    { name: "clai", tag: "JS / Utility", desc: "Check lockfiles and install.", url: "https://github.com/xarunoba/clai", img: "https://opengraph.githubassets.com/1/xarunoba/clai" },
    { name: "env-struct.zig", tag: "Zig / Lib", desc: "Parse env vars to typed structs.", url: "https://github.com/xarunoba/env-struct.zig", img: "https://opengraph.githubassets.com/1/xarunoba/env-struct.zig" },
    { name: "Davao Oriental State University Library", tag: "Vue.js / Portal", desc: "A handmade library portal for DOrSU.", url: "https://dorsulibrary.net", img: "/dorsu_library.png" },
  ];
