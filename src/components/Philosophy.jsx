  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?q=80&w=1600&auto=format&fit=crop")',
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full">
        ...
        <div className="phil-text-2 mt-12 max-w-2xl">
          <p className="font-data text-sm text-dark/50 uppercase tracking-widest leading-relaxed">
            There's something magical about turning a blank file into a fully
            functional application that solves real problems. Whether it's
            crafting responsive interfaces that work seamlessly across devices
            or architecting backends that scale, I'm driven by the challenge of
            making complex technology feel simple and intuitive.
          </p>
        </div>
      </div>
    </section>
