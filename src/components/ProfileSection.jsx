...
const ProfileSection = () => {
  const techStack = [
    "Go (Golang)", "Zig", "TypeScript", "JavaScript", "Vue.js", "Nuxt", "React.js",
    "Next.js", "Node.js", "Bun", "Electron", "Tailwind CSS", "Docker", "Git"
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start mb-32">
        ...
        <div className="md:col-span-8">
          ...
          <p className="font-data text-lg text-dark/80 leading-relaxed mb-12 max-w-2xl">
            A programming enthusiast hailing from the Philippines. When I'm not busy with life, you can find me tinkering with open-source software or developing projects for the community.
          </p>

          {/* Tech Stack Grid */}
          <div>
            <div className="font-data text-xs text-dark/40 uppercase tracking-widest mb-4">Core Technology Stack</div>
            <div className="flex flex-wrap gap-2">
              {techStack.map(tech => (
                <span key={tech} className="border border-dark/10 bg-white px-3 py-1 font-data text-xs text-dark/70 hover:border-accent hover:text-accent transition-colors">
                  {tech}
                </span>
              ))}
            </div>
