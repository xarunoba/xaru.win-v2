  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1599707254554-027aeb4deacd?q=80&w=1600&auto=format&fit=crop")',
          transform: "translateZ(0)",
        }}
      ></div>
      {/* Heavy Gradient Overlay */}
      <div className="absolute inset-0 bg-linear-to-t from-dark via-dark/80 to-transparent z-10"></div>
